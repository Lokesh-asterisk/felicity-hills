...
ALTER TABLE IF EXISTS ONLY public.site_visits DROP CONSTRAINT IF EXISTS site_visits_pkey;
ALTER TABLE IF EXISTS ONLY public.session DROP CONSTRAINT IF EXISTS session_pkey;
ALTER TABLE IF EXISTS ONLY public.projects DROP CONSTRAINT IF EXISTS projects_pkey;
ALTER TABLE IF EXISTS ONLY public.plots DROP CONSTRAINT IF EXISTS plots_plot_number_unique;
ALTER TABLE IF EXISTS ONLY public.plots DROP CONSTRAINT IF EXISTS plots_pkey;
...
ALTER TABLE IF EXISTS ONLY public.brochures DROP CONSTRAINT IF EXISTS brochures_pkey;
ALTER TABLE IF EXISTS ONLY public.brochure_downloads DROP CONSTRAINT IF EXISTS brochure_downloads_pkey;
...
DROP TABLE IF EXISTS public.brochure_downloads;

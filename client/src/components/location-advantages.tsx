        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          ...
          <Card className="bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200 hover:shadow-lg transition-all duration-300 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            <CardContent className="p-6 text-center">
              ...
              <div className="text-gray-600">Northeast direction</div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gradient-to-br from-orange-50 to-orange-100 border-orange-200 hover:shadow-lg transition-all duration-300 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
            <CardContent className="p-6 text-center">
              ...
              <div className="text-2xl font-bold text-orange-600 mb-1">35 km</div>
              <div className="text-gray-600">North direction</div>
            </CardContent>
          </Card>
        </div>
          ...
          <CardContent className="p-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="flex items-center">
                ...
                <div>
                  <div className="font-semibold">Uttarakhand Border</div>
                  <div className="text-sm text-gray-600">Gateway to hills</div>
                </div>
              </div>
              
              <div className="flex items-center">
                <Car className="text-primary text-xl mr-3 w-6 h-6" />
                <div>
                  <div className="font-semibold">NH-307 Expressway</div>
                  <div className="text-sm text-gray-600">Just 3 km away</div>
                </div>
              </div>
